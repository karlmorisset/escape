...
class HomeController extends AbstractController
{
    ...
    #[Route('/ch3-1', name: 'ch3-1')]
    public function ch31(): Response
    {
        $lines = [
            "linew",
            "linew",
        ...
        // dd(intval("000101001100100100110101111010111101010101000011011001100110100100010100"));

        // $code = bindec(intval($code));
